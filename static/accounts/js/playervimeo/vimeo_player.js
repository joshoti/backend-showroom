...
!function(e, t) {
    ...
    (o = "undefined" != typeof self ? self : "undefined" != typeof window ? window : l).WeakMap || (a = Object.prototype.hasOwnProperty,
    u = function(e, t, n) {
    ...
    u(f.prototype, "set", function(e, t) {
        ...
        var n = e[this._id];
        return n && n[0] === e ? n[1] = t : u(e, this._id, [e, t]),
        this
    }),
    u(f, "_polyfill", !0),
    f));
    var v, p = (function(e) {
        ...
        r = function() {
            ...
            return t(y.prototype = g, "__NPO__", 0, !1),
    ...
    var F, x, C, j = new WeakMap, A = new WeakMap, q = {}, Player = function() {
        function Player(u) {
            ...
            var r, o = new p(function(i, a) {
                ...
                l._onMessage = function(e) {
                    if (c(e.origin) && l.element.contentWindow === e.source) {
                        ...
                        var r = t && "ready" === t.event
                          , o = t && "ping" === t.method;
                        if (r || o)
                            return l.element.setAttribute("data-ready", "true"),
                            void i();
                        N(l, t)
                    }
                }
                ...
                "IFRAME" !== l.element.nodeName && P(s(e = E(u, n)), e, u).then(function(e) {
                    var t, n, r, o = T(e, u);
                    return l.element = o,
        ...
        (t = [{
            ...
            value: function(e, t) {
                ...
                0 === w(this, "event:".concat(e)).length && this.callMethod("addEventListener", e).catch(function() {}),
            ...
            value: function() {
                ...
                return new p(function(e) {
                    ...
                    A.delete(n),
                    j.delete(n.element),
                    n._originalElement && (j.delete(n._originalElement),
    ...
    C = {
        ...
        exit: function() {
            return new Promise(function(t, e) {
                ...
                ,
                C.on("fullscreenchange", n),
                (r = document[F.exitFullscreen]())instanceof Promise && r.then(n).catch(e)) : t()
            }
            )
        },
        on: function(e, t) {
